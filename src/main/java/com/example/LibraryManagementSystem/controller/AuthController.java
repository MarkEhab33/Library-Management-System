...
import com.example.LibraryManagementSystem.dto.AuthResponseDTO;
...
import com.example.LibraryManagementSystem.security.JWTGenerator;
...
public class AuthController {
    ...
    public ResponseEntity<String> register(@RequestBody RegisterDto registerDto) {
        ...
        // Fetch the role and handle the case where it might not be present
